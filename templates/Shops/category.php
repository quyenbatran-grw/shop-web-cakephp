    ...
    <div class="row row-cols-3">
        ...
        <div class="col fix-wp-33">
            ...
            <div class="card mb-3 fix-h-23">
                ...
                <div class="card-body text-wrap p-1">
                    <h4 class="card-title fw-bold"><?=$product->name?> <span class="text-danger fs-6"><?=$product_inventory->price_k?>K</span></h4>
